...
fold_accuracies = []
max_depth = 15  # Specify the fixed depth here
...
print("Average Cross-Validation Accuracy with Max Depth for testing data", max_depth, ":", average_accuracy)
print("Standard Deviation of Cross-Validation Accuracy for testing data:", std_deviation)
 # Evaluate the model on train data
fold_accuracies_train = []
fold_accuracy_train = evaluate(tree, train_data, 'label')
fold_accuracies_train.append(fold_accuracy_train)

# Calculate average accuracy
average_accuracy = np.mean(fold_accuracies_train)
std_deviation = np.std(fold_accuracies_train)

print("Average Cross-Validation Accuracy with Max Depth for training data", max_depth, ":", average_accuracy)
print("Standard Deviation of Cross-Validation Accuracy for training data:", std_deviation)